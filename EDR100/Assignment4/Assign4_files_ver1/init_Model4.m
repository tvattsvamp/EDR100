...
PEC_scaling = 1;     % Scale of PEC power. 1.0 corresponds to ca 150 kW PMSM or IPM traction machine


%% Battery System (ESS) data
% Main parameters to configure by students below here
ESS_start_SOC = 90;         % (%) State of charge at beginning of simulation
ESS_cell_Qmax = 5;         % (Ah) Charge capacity of each battery cell
ESS_cells_series = 96;     % How many cells in series?
ESS_cells_parallel = 35;    % How many cells in parallel?
ESS_cell_Cvalue = 2;      % Max relative peak current (C-rate). 1-3 C for EV packs, 5-10 C for PHEV packs.
...
m_v = 1700;                % (kg) Vehicle total mass
